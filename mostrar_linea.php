    ...
    <div class="container-fluid text-center">
        ...
        <div class="col-sm-8 text-left">
            ...
            <table class="table table-hover">
                        ...
                        if ($tabla->num_rows == 0) {
                            ...
                            while($row = $tabla->fetch_assoc()) {
                                echo "</td><td>".$row['apellido'].
                                    ...
                                    "</td><td><a href='Ingresar_llamada.php?id=".$row['id_linea'].
                                    "' alt='edit' class='btn btn-primary'>Agregar Llamada</a>

                                    </td><td><a href='mostrar_llamada.php?id=".$row['id_linea'].
                                    "' alt='edit' class='btn btn-info'>Ver Llamadas</a>

                                    </td><td><a href='D_Linea.php?id=".$row['id_linea'].
              ...
              <p><a href="LineasPDF.php" class="btn btn-info">PDF</a></p>
        </div>
    </div>
