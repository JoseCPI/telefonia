<html>
	<head>
		<title>Ingresar Linea - Compañias Telefonicas</title>
	    <meta charset="utf-8">
				...
				<div class="col-sm-8 text-left">
					...
					<!--  -->
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="tel" placeholder="555-12345">
						</div>
						<div class="form-group">
							<label for="tipo">Tipo de Linea</label>
							<input type="text" class="form-control" name="tipo" placeholder="Local">
						</div>
